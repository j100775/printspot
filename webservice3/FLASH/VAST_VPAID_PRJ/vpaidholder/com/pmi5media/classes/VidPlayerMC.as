	...
	public class VidPlayerMC extends MovieClip {
		...
		private function addedTS(e: Event): void {
			try {
				...
				objPlayPause.x = 0;
				objPlayPause.width = 32;
				objPlayPause.height = 32;
				objPlayPause.y = 0;
				objPlayPause.addEventListener(MouseEvent.CLICK, playpauseClick);


				objMuteBtn.width = 32;
				objMuteBtn.height = 32;
				...
				bgShape2.graphics.drawRect(0, 0, 64, 32);
		...
		public function loadnPlayVideo(pXml: XMLList): void {
			try {
				...
				if (barlen > 0) {
					objBtnbar.x = pXml.btnbaroffsetx;
					objBtnbar.y = pXml.btnbaroffsety;
				} else {
					objBtnbar.x = 0;
