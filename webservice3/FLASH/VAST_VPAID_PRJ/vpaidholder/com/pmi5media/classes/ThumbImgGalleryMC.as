package com.pmi5media.classes {
	...
	public class ThumbImgGalleryMC extends MovieClip {
		...
		function tweenFinish(et: TweenEvent): void {
			try {
				...
				trace("tween finish error - " + e.message);
			}
		...
		private function setImaage(): void {
			try {
				...
				var duplicationBitmap: Bitmap =  imgLoader.content as Bitmap;
				duplicationBitmap.smoothing=true;
				duplicationBitmap.pixelSnapping = PixelSnapping.AUTO;
		...
		/*		imgBgMC.x = imgLoader.x;
				...
				trace("thumbImgGalleryMc - setImage Error");
			}
